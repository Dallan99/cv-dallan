...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initButtonEffects() {
        const buttons = document.querySelectorAll('.github-link, .live-demo, .social-link');
    ...
    function initProjectLinksEnhancement() {
        const projectLinks = document.querySelectorAll('.github-link, .live-demo');
    ...
    // Add necessary CSS for mobile navigation
